            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info" id="account">
                        <p><?= $_SESSION['name']; ?></p>
                        <?php if (hasPermit('update_profile')) { ?>
                        <a id="password" name="password" href="<?= BASE_URL.'dashboard/'.strtolower(str_replace(' ','-',$menu[2])).'/@'.strtolower($_SESSION['username']).'/' ?>">
                    ...
                    <?php if (hasPermit('menu_data')) { ?>
                        <li class="treeview <?= @$_REQUEST['menu'] == strtolower(str_replace(' ', '-', $menu[0])) ? 'active' : '' ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php } ?> 
                                <?php if (hasPermit('submenu_data_kategori')) { ?>
                                ...
                                <?php } ?> 
                                <?php if (hasPermit('submenu_data_penerbit')) { ?>
                                ...
                                <?php } ?> 
                                <?php if (hasPermit('submenu_data_pengarang')) { ?>
                                    <li class="<?= @$_REQUEST['menu'] == strtolower(str_replace(' ', '-', $menu[0])) && @$_REQUEST['submenu'] == strtolower(str_replace(' ', '-', $submenu[3])) ? 'active' : '' ?>">
                                        <a href="<?= BASE_URL . 'dashboard/' .strtolower(str_replace(' ', '-', $menu[0])). '/' .strtolower(str_replace(' ', '-', $submenu[3])). '/' ?>" class="menu">
                                            <i class="fa fa-circle-o text-blue"></i>
                                            <span><?= $submenu[3] ?></span>
                                        </a>
                                    </li>
                                <?php } ?> 
                                <?php if (hasPermit('submenu_data_buku')) { ?>
                                    <li class="<?= @$_REQUEST['menu'] == strtolower(str_replace(' ', '-', $menu[0])) && @$_REQUEST['submenu'] == strtolower(str_replace(' ', '-', $submenu[4])) ? 'active' : '' ?>">
                                        <a href="<?= BASE_URL . 'dashboard/' .strtolower(str_replace(' ', '-', $menu[0])). '/' .strtolower(str_replace(' ', '-', $submenu[4])). '/' ?>" class="menu">
                                            <i class="fa fa-circle-o text-yellow"></i>
                                            <span><?= $submenu[4] ?></span>
                                        </a>
                                    </li>
                                <?php } ?>
                                <?php if (hasPermit('submenu_data_rak')) { ?>
                                    <li class="<?= @$_REQUEST['menu'] == strtolower(str_replace(' ', '-', $menu[0])) && @$_REQUEST['submenu'] == strtolower(str_replace(' ', '-', $submenu[5])) ? 'active' : '' ?>">
                                        <a href="<?= BASE_URL . 'dashboard/' .strtolower(str_replace(' ', '-', $menu[0])). '/' .strtolower(str_replace(' ', '-', $submenu[5])). '/' ?>" class="menu">
                        ...
                        <li class="treeview <?= @$_REQUEST['menu'] == strtolower(str_replace(' ', '-', $menu[1])) ? 'active' : '' ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php if (hasPermit('submenu_transaksi_pengembalian')) { ?>
                                    <li class="<?= @$_REQUEST['menu'] == strtolower(str_replace(' ', '-', $menu[1])) && @$_REQUEST['submenu'] == strtolower(str_replace(' ', '-', $submenu[7])) ? 'active' : '' ?>">
                                        <a href="<?= BASE_URL . 'dashboard/' .strtolower(str_replace(' ', '-', $menu[1])). '/' .strtolower(str_replace(' ', '-', $submenu[7])). '/' ?>" class="menu">
                                            <i class="fa fa-circle-o text-yellow"></i>
                                            <span><?= $submenu[7] ?></span>
                                        </a>
                                    </li>
