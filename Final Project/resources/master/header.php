<?php 
  session_set_cookie_params(0,'/sisinfoperpus'); 
  session_start();
  ...
  include_once (ABSPATH . '../config/route.php');
  include_once (ABSPATH . '../config/static.php');
  
  $url = BASE_URL;
  if (FIRST_PART == "login" || FIRST_PART == "register") {
    if (isset($_SESSION['is_logged']) && isset($_COOKIE['sisteminformasiperpustakaan'])) {
          ...
          <nav class="navbar navbar-static-top">
            <div class="container">
              <div class="navbar-header">
                <a href="<?= BASE_URL . 'home/' ?>" class="navbar-brand"><b>Sistem</b>Perpustakaan</a>
